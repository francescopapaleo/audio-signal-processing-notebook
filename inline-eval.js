/**
 * Browser-side inline expression evaluator for MyST/Jupyter Book
 * This script allows inline expressions to be evaluated in the browser
 * by reading values from code cell outputs.
 */
...
(function() {
    ...
    function extractVariables() {
        ...
        const jsonScripts = document.querySelectorAll('script[type="application/json"][id^="wave-params"], script[type="application/json"][id^="var-data"]');
